...
class SellerBlockAccounts extends StatefulWidget {
  const SellerBlockAccounts({Key? key}) : super(key: key);

  @override
  State<SellerBlockAccounts> createState() => _SellerBlockAccountsState();
}

class _SellerBlockAccountsState extends State<SellerBlockAccounts> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title:const Text('Sellers - Active Accounts',
